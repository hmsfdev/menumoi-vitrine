    ...
    <section id="testimonials" className="bg-gray-50 py-20">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <p className="text-lg text-center text-gray-600 mb-12">
          Nous avons identifié les problèmes courants rencontrés par les
          restaurants. Voici comment MenuMoi les résout efficacement.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                Les commandes sur papier ou par téléphone prennent du temps et
                augmentent le risque d'erreurs.
              </p>
              <p className="text-sm text-[#5E8F3F] font-medium mt-2">
                <span className="font-bold">MenuMoi :</span> Digitalisez vos
                commandes avec un menu interactif simple et intuitif.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                Les réservations manuelles sont souvent source de confusion et
                de double réservation.
              </p>
              <p className="text-sm text-[#5E8F3F] font-medium mt-2">
                <span className="font-bold">MenuMoi :</span> Offrez une
                réservation en ligne, instantanée et bien organisée.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">
                Les paiements en ligne peuvent être complexes à intégrer et à
                gérer.
              </p>
              <p className="text-sm text-[#5E8F3F] font-medium mt-2">
                <span className="font-bold">MenuMoi :</span> Intégrez Stripe et
                recevez vos paiements instantanément.
              </p>
            </div>
          </div>
        </div>
